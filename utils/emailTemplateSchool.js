        ...
        <table width="620" cellpadding="0" cellspacing="0"
          ...
          <tr>
            <td style="background:linear-gradient(135deg, #7b3f8c, #a86bbf); padding:30px; text-align:center; color:#ffffff;">
              ...
              <p style="margin:8px 0 0; font-size:14px; opacity:0.9;">
                A new ${inquirytypeDisplay(formData.inquiry)} has been submitted through the MMET English School Portal.
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style="background:#fafafa; padding:18px; text-align:center; font-size:12px; color:#888;">
              MMET English School –  Portal Notification
              <br><br>
              © 2026 MMET English  School. All rights reserved.
            </td>
          </tr>
...
export default emailTemplateSchool;
